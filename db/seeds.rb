...
Rent.create(property: , renter_name: 'jack', rent_time_period_in_months: 15, rent_cost_in_dollars: 50000, deposit_amount: 5000)
Rent.create(property: , renter_name: 'paul', rent_time_period_in_months: 24, rent_cost_in_dollars: 140000, deposit_amount: 14000)
Rent.create(property: , renter_name: 'sita', rent_time_period_in_months: 12, rent_cost_in_dollars: 54000, deposit_amount: 9000)
Rent.create(property: , renter_name: 'pavan', rent_time_period_in_months: 36, rent_cost_in_dollars: 990000, deposit_amount: 90000)
Rent.create(property: , renter_name: 'pavan', rent_time_period_in_months: 36, rent_cost_in_dollars: 1500000, deposit_amount: 15000)
Rent.create(property: , renter_name: 'karthik', rent_time_period_in_months: 12, rent_cost_in_dollars: 70000, deposit_amount: 7000)
Rent.create(property: , renter_name: 'ravi', rent_time_period_in_months: 18, rent_cost_in_dollars: 750000, deposit_amount: 7000)
